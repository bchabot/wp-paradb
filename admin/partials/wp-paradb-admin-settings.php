	...
	<form method="post" action="" enctype="multipart/form-data">
		...
		<form method="post" action="" enctype="multipart/form-data">
					...
					<tr>
						...
						<td>
							...
							<p class="description">
								...
								<a href="https://console.cloud.google.com/google/maps-apis/credentials" target="_blank"><?php esc_html_e( 'Get Key', 'wp-paradb' ); ?></a>
							</p>
						</td>
					</tr>
					<tr>
			...
			<?php if ( 'advanced' === $active_tab ) : ?>
				<h2 class="title"><?php esc_html_e( 'Advanced & Database', 'wp-paradb' ); ?></h2>
				<table class="form-table">
					<tr>
			...
			<?php endif; ?>
							...
							<?php if ( 'advanced' === $active_tab ) : ?>
								...
								<table class="form-table">
									...
									<tr>
										<th scope="row"><?php esc_html_e( 'Database Info', 'wp-paradb' ); ?></th>
										<td>
						...
						<?php if ( 'advanced' === $active_tab ) : ?>
							<hr>
							<h3><?php esc_html_e( 'Maintenance Operations', 'wp-paradb' ); ?></h3>
							<table class="form-table">
								<tr>
